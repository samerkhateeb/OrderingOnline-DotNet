<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Blocks.ascx.cs" Inherits="Admin.Admin.Controls.Blocks.Blocks" %>
...
<asp:GridView ID="ManagerGridView" runat="server" 
    AutoGenerateColumns="False" DataKeyNames="Block_ID"  
    ...
    <Columns>
        ...
        <asp:BoundField DataField="Block_Name" HeaderText="Name" />
        <asp:BoundField DataField="Block_Sorting" HeaderText="Sorting" />
        <asp:CheckBoxField DataField="Block_Status" HeaderText="Status" />
        ...
        <asp:TemplateField HeaderText="Edit">
            <ItemTemplate>
                <asp:HyperLink ID="HyperLink1" runat="server" CssClass="GV_EditBtn" 
                    NavigateUrl='<%# String.Format("/admin/default.aspx?id={0}&controlid={1}&status=edit", Eval("Block_ID"), Request.QueryString["controlid"]) %>' 
                    Text=""></asp:HyperLink>
            </ItemTemplate>
        </asp:TemplateField>
