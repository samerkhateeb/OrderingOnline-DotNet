<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Objects.ascx.cs" Inherits="Admin.Admin.Controls.Objects.Objects" %>
...
<asp:GridView ID="ManagerGridView" runat="server" 
    AutoGenerateColumns="False" DataKeyNames="Object_ID" 
    ...
    <Columns>
        <asp:BoundField DataField="Object_ItemID" HeaderText="ItemID" />
        <asp:BoundField DataField="Object_ParentID" HeaderText="ParentID" />
        <%--<asp:BoundField DataField="Object_Levels" HeaderText="Levels" />--%>
        ...
        <asp:TemplateField HeaderText="Edit">
            <ItemTemplate>
                <asp:HyperLink ID="HyperLink1" runat="server" CssClass="GV_EditBtn" 
                    NavigateUrl='<%# String.Format("/admin/default.aspx?id={0}&controlid={1}&status=edit", Eval("Object_ID"), Request.QueryString["controlid"]) %>' 
                    Text=""></asp:HyperLink>
            </ItemTemplate>
        </asp:TemplateField>
